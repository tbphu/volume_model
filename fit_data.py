...
def define_bounds(parameters_to_fit, reference_params, bounds={}):
    ...
    for k,p_id in enumerate(parameters_to_fit):
      ...
      if p_id in bounds.keys():
        ...
        xmin[k] = reference_params[p_id]*0.005 
        xmax[k] = reference_params[p_id]*500   
...
def fit_model_to_data(model,
    ...
    if optimizer == 'basin':
        ...
        return fit_cmaes(initial_params, additional_arguments, xmin, xmax,sigma0=4e-17, tolx=tolx)
    else:
